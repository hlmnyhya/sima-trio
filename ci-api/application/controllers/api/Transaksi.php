...
class Transaksi extends REST_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('laporan/m_laporan_ga', 'mlapga');
    ...
    public function Inv_put()
    {
        ...
        $data = [
            ...
            'nilai_total_keseluruhan' => $this->put(
                'nilai_total_keseluruhan',
                true
            ),
            'tanggal_barang_diterima' => $this->put(
    ...
    public function cetakGa_get()
    {
        $id = $this->get('id');
        $offset = $this->get('offset');
        $cabang = $this->get('cabang');
        if ($id === null && $offset === null) {
            $listinv = $this->mlapga->cetaklaporan($id, $offset, $cabang);
        } elseif ($id === null && $offset != null) {
            $listinv = $this->mlapga->cetaklaporan($id, $offset, $cabang);
        } else {
            $listinv = $this->mlapga->cetaklaporan($id, $offset, $cabang);
