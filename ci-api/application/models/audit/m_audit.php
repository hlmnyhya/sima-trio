...
class M_Audit extends CI_Model {
    ...
    public function GetListpart($id = null, $cabang = null, $kd_lokasi_rak=null, $qty=null)
    {
        if ($id===null) {
...
public function GetListAudPart($id = null, $cabang = null, $idjadwal_audit = null)
    ...
    public function GetAuListpart($id = null,$lokasi=null,$cabang= null, $idjadwal_audit = null, $rakbin = null, $qty = null)
    {
        if ($id === null) {
            $this->db->select('a.*, b.nama_cabang, c.nama_gudang');
            $this->db->from('part a');
