...
<script>
    $(document).ready(function() {
        $('#divisi').load("<?php echo base_url() ?>divisi/ajax_get_divisi");

        function search() {
            var divisi = $('#Indivisi').val();

            if (divisi != '') {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url() ?>divisi/search_data",
                    data: "divisi=" + divisi,
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() . $this->uri->segment(1) ?>/edit",
            type: 'post',
            data: "id=" + id,
            dataType: 'html',
            success: function(data) {
    ...
    function show() {
        ...
        $.ajax({
            url: "<?php echo base_url() . $this->uri->segment(1) ?>/input",
            type: 'post',
            dataType: 'html',
            success: function(data) {
                $('#data_input').html(data);
