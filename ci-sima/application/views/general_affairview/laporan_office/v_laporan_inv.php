                    ...
                    <form id="FormLap" action="<?php echo base_url() ?>laporan_ga/cetaklaporan" method="post">
                        <div class="row">
                                <div class="col-sm-2"><label>Cari Inventory Office</label></div>
                                 <div class="col-sm-6"><input type="text" class="form-control" id="inv"></div>
                                 <div class="col-sm-2 text-center"><button class="btn btn-w-m btn-success" id="caribtn">Cari Data</button></div>
