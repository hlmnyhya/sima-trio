            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-sm-2"><label>Cari Rakbin</label></div>
                        <div class="col-sm-8"><input type="text" class="form-control" id="inRakbin"></div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <div class="col-lg-11">
                        <h3><i class="fa fa-info-circle"></i> List Data Rakbin</h3>
                    </div>
                    <div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Rakbin</th>
                                </tr>
                            </thead>
                            <tbody id="rakbin">
                            </tbody>
