            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-sm-2"><label>Cari Status Inventory</label></div>
                        <div class="col-sm-8"><input type="text" class="form-control" nama="cari" id="Instatusinv"></div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <div class="col-lg-11">
                        <h3><i class="fa fa-home"></i> List Data Status Inventory</h3>
                    </div>
                    <div>
