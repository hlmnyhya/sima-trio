...
<script>
    $(document).ready(function() {
        ...
        var idjenis_inventory = "<?php echo $jenis ?>";
        ...
        $('#OptStatusInv').load("<?php echo base_url() ?>transaksi_ga/ajax_get_statusinv2/<?php echo $status ?>");
        $('#OptVendor').load("<?php echo base_url() ?>transaksi_ga/ajax_get_vendor2/<?php echo $vendor ?>");
        $('#OptJenisInv').load("<?php echo base_url() ?>transaksi_ga/ajax_get_jenisinv2/<?php echo $jenis ?>");
